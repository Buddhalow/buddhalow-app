                        ...
                        React.createElement(
                            Line,
                            {
                                ...
                                data: {
                                    ...
                                    labels: result.infection.report.fungaldaySet.map(o => moment(o.time).format('YYYY-MM-DD'))
                                },
                                options: {
                                    scales: {
                                        yAxes: [{
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                'tbody',
                                null,
                                result.infection && result.infection.fungaltreatmentSet.map((o, i) => {
                                    return React.createElement(
                                        'tr',
                                        {
                                            key: i
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                'tbody',
                                null,
                                result.infection.fungaltransactionSet.map((o, i) => {
                                    return React.createElement(
                                        'tr',
                                        {
                                            key: i
